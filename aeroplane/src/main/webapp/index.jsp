...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
  <a class="navbar-brand" href="#"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQGzVwcBGSxKn81Vp8nmWnA8y7P3bkZJQ-zJg&usqp=CAU" alt="" height="90px" width="150px"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit"><a href="aeroplane">Register</a></button>
    </form>
  </div>
</nav>
<body>
<div class="index">
<b>Welcome to Air-Way lines....</b>
</div>
</body>
<style>
    body{
