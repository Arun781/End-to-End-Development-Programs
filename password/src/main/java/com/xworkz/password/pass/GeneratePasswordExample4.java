package com.xworkz.password.pass;
...
public class GeneratePasswordExample4 {
	// main() method start
	public static void main(String args[]) {
		// call generateSecurePassword() method to generate random password using Custom
		// Utility Method
	...
	// create generateSecurePassword() method that find the secure 10 digit password
	// and returns it to the main() method
	public static String generateSecurePassword() {

		// generate a string having 2 numbers, 2 special chars, 2 upper case letters,
		// and 2 lower case letters
		Stream<Character> demoPassword = Stream.concat(getRandomNumbers(2), Stream.concat(getRandomSpecialChars(2),
				Stream.concat(getRandomAlphabets(2, true), getRandomAlphabets(2, false))));

		// create a list of Char that stores all the characters, numbers, and special
		// characters
		...
		// generate a random string(secure password) by using list stream() method and
		// collect() method
	...
	public static Stream<Character> getRandomSpecialChars(int length) {
		...
		// use ints() method of random to get IntStream of special chars of the
		// specified length
	...
	// create getRandomAlphabets() method that returns either a stream of upper case
	// chars or stream of lower case chars
	...
	public static Stream<Character> getRandomAlphabets(int length, boolean check) {
		...
		if (check == true) {
			...
			// use ints() method of random to get IntStream of lower case letters of the
			// specified length
		...
		// for upper case stream
			...
			// use ints() method of random to get IntStream of upper case letters of the
			// specified length
